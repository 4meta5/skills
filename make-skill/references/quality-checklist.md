...
### "Invalid category"
Use one of: testing, development, documentation, refactoring, security, performance, code-quality, deployment, database, framework, workflow, memory, communication. For new categories (e.g. devops), update cross-repo category contracts first.
