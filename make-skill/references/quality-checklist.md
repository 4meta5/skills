...
- [ ] `node ../skillex/packages/skills-cli/bin/skills.js validate <skill-name>` passes
- [ ] `../hooks` packages build cleanly after taxonomy/name changes
- [ ] `node ../skillex/packages/skills-cli/bin/skills.js sync <skill-name> --push` run after change
